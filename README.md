...
**Auteur :** Abdalla (Étudiant Master 2 ESTEL - Université Côte d'Azur)

Ce dépôt est un guide complet et francophone pour la prise en main du kit de développement **STM32N6570-DK**, avec un focus particulier sur l'**Intelligence Artificielle Embarquée (TinyML)** et la détection d'objets.
...
- 🛠️ Installation de STM32CubeIDE (v1.17.0) et CubeProgrammer (v2.18.0).
- 🍎 **Solutions pour Mac** (VM, Boot Camp, Parallels).
...
- ⚙️ Utiliser **STEdgeAI v2.2.0** pour générer et quantifier vos propres modèles.
...
- **Câble :** USB Type-C de bonne qualité (Data + Power)
